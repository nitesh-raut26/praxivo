...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="flex size-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lift ring-[3px] ring-[#25D366]/15 transition-transform duration-200 group-hover:scale-105 group-active:scale-95">
